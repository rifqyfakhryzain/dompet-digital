<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Tambah Transaksi</h2>
                <p class="text-sm text-slate-500">Catat pemasukan atau pengeluaran baru Anda.</p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100">
                <form method="POST" action="{{ route('transaksi.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="jumlah_tampil" 
                                   ...
                                   placeholder="0" required oninput="formatRibuan(this)">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="keterangan" placeholder="Contoh: Jajan bakso"
                               class="w-full border-slate-200 rounded-2xl focus:border-emerald-500 focus:ring focus:ring-emerald-500/10 text-sm font-semibold text-slate-700 px-4 py-3">
                    </div>

                    {{-- Action Buttons --}}
                    <div class="flex flex-col gap-3 pt-4">
                        <button type="submit" class="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold rounded-2xl shadow-lg shadow-emerald-200 transition-all active:scale-95">
                            Simpan Transaksi
                        </button>
    ...
    <script>
        function formatRibuan(input) {
            ...
            input.setSelectionRange(selectionStart + diff, selectionEnd = selectionStart + diff);
        }
    </script>
</x-app-layout>